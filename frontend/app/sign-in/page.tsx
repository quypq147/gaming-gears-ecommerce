    ...
    >
      ...
      >
        <Card className="w-full max-w-md bg-opacity-10 backdrop-blur-lg border border-gray-700 shadow-xl rounded-xl text-white">
          <CardHeader>
            <CardTitle className="text-center text-3xl font-bold">Sign In to GameSome</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      >
        ...
        <Link href="/sign-up" className="text-blue-500 hover:text-blue-400 transition font-medium">
          Join Now
        </Link>
      </motion.p>
    </motion.div>
