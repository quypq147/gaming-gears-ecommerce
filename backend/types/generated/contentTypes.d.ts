...
export interface ApiCpuSpecCpuSpec extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    base_clock: Schema.Attribute.Decimal;
    boost_clock: Schema.Attribute.Decimal;
    cache: Schema.Attribute.Integer;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cpu-spec.cpu-spec'
    > &
      Schema.Attribute.Private;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    socket: Schema.Attribute.String;
    threads: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeadphoneSpecHeadphoneSpec
  extends Struct.CollectionTypeSchema {
  collectionName: 'headphone_specs';
  info: {
    description: '';
    displayName: 'HeadphoneSpec';
    pluralName: 'headphone-specs';
    singularName: 'headphone-spec';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    battery_life: Schema.Attribute.Integer;
    connectivity: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    driver_size: Schema.Attribute.Integer;
    frequency_response: Schema.Attribute.String;
    impedance: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::headphone-spec.headphone-spec'
    > &
      Schema.Attribute.Private;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiKeyBoardSpecKeyBoardSpec
  extends Struct.CollectionTypeSchema {
  collectionName: 'key_board_specs';
  info: {
    description: '';
    displayName: 'KeyBoardSpec';
    pluralName: 'key-board-specs';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    led: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::key-board-spec.key-board-spec'
    > &
      Schema.Attribute.Private;
    models: Schema.Attribute.String;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    switch: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMonitorSpecMonitorSpec extends Struct.CollectionTypeSchema {
  collectionName: 'monitor_specs';
  info: {
    description: '';
    displayName: 'MonitorSpec';
    pluralName: 'monitor-specs';
    singularName: 'monitor-spec';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::monitor-spec.monitor-spec'
    > &
      Schema.Attribute.Private;
    panel_type: Schema.Attribute.String;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMousePadSpecMousePadSpec
  extends Struct.CollectionTypeSchema {
  collectionName: 'mouse_pad_specs';
  info: {
    description: '';
    displayName: 'MousePadSpec';
    pluralName: 'mouse-pad-specs';
    singularName: 'mouse-pad-spec';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    anti_slip: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    led: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mouse-pad-spec.mouse-pad-spec'
    > &
      Schema.Attribute.Private;
...
export interface ApiMouseSpecMouseSpec extends Struct.CollectionTypeSchema {
  collectionName: 'mouse_specs';
  info: {
    description: '';
    displayName: 'MouseSpec';
    pluralName: 'mouse-specs';
    singularName: 'mouse-spec';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    buttons: Schema.Attribute.Integer;
    connectivity: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dpi: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    sensor: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    discountPercent: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    headphone_spec: Schema.Attribute.Relation<
      'oneToOne',
      'api::headphone-spec.headphone-spec'
    >;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos', true>;
    key_board_spec: Schema.Attribute.Relation<
      'oneToOne',
      'api::key-board-spec.key-board-spec'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    monitor_spec: Schema.Attribute.Relation<
      'oneToOne',
      'api::monitor-spec.monitor-spec'
    >;
    mouse_pad_spec: Schema.Attribute.Relation<
      'oneToOne',
      'api::mouse-pad-spec.mouse-pad-spec'
    >;
    mouse_spec: Schema.Attribute.Relation<
      'oneToOne',
      'api::mouse-spec.mouse-spec'
    >;
...
export interface ApiVgaSpecVgaSpec extends Struct.CollectionTypeSchema {
  collectionName: 'vga_specs';
  info: {
    description: '';
    displayName: 'VgaSpec';
    pluralName: 'vga-specs';
    singularName: 'vga-spec';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    boost_clock: Schema.Attribute.Decimal;
    core_clock: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vga-spec.vga-spec'
    > &
      Schema.Attribute.Private;
    memory_type: Schema.Attribute.String;
    power_draw: Schema.Attribute.Decimal;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vram: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::key-board-spec.key-board-spec': ApiKeyBoardSpecKeyBoardSpec;
